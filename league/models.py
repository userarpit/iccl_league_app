...
class Sponsor(models.Model):
    ...
    name = models.CharField(max_length=80, help_text="Name of the sponsor")
    sponsor_type = models.CharField(
        max_length=30, help_text="Type of sponsor (max 30 characters)"
    )
    ...
    description = models.TextField(
        blank=True, null=True, help_text="Description of the sponsor"
    )

    location = models.CharField(
        max_length=255, blank=True, null=True, help_text="Location of sponsor"
    )
    ...
    instagram = models.CharField(
        max_length=100,  # enough to store handles or simple text
        blank=True,
        null=True,
        help_text="Instagram handle or simple text",
    )

    linktree = models.URLField(blank=True, null=True, help_text="Linktree URL")
